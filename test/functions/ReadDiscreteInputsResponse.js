...
describe("ReadDiscreteInputsResponse", function()
{
  ...
  describe("fromBuffer", function()
  {
    it("should throw if the specified Buffer is not at least 1 byte long", function()
    {
      function test()
      {
        ReadDiscreteInputsResponse.fromBuffer(Buffer.from([]));
      }
    ...
    it("should throw if the first byte is an invalid function code", function()
    {
      function test()
      {
        ReadDiscreteInputsResponse.fromBuffer(Buffer.from([0x01, 0x00]));
      }
    ...
    {
      ReadDiscreteInputsResponse.fromBuffer(Buffer.from([0x02, 0x02, 0xCB, 0x01, 0xFF])).getStates().should.be.eql([
