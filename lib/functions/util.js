...
exports.addressTranslator = function(address)
{
   ...
   */
  if (address >= 0x00 && address <= 0x4F) {
    return 0x0A0 + (address - 0x00);
  } else if (address >= 0x50 && address <= 0x6F) {
    return 0x190 + (address - 0x50);
  } else if (address >= 0x80 && address <= 0x9F) {
    return 0x1B0 + (address - 0x80);
  } else if (address >= 0xB0 && address <= 0xDF) {
    return 0x130 + (address - 0xB0);
  } else {
