...
function createConnection(options) {
  ...
  if(options instanceof Connection) {
    // user has provided their own  instance; we don't have to make one
    return options;
  }
...
function createTransport(options) {
  if(options instanceof Transport) {
    // user has provided their own transport instance; we don't have to make one
    return options;
  }
